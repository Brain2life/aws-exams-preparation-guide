...
3. [AWS EFS migration with AWS DataSync](https://brain2life.hashnode.dev/aws-efs-migration-with-aws-datasync)
...
- [Execution context in AWS Lambda](https://brain2life.hashnode.dev/execution-context-in-aws-lambda)
